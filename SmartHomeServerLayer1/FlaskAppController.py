...
class FlaskAppController:
    ...
    def __init__(self):
        self.esp_communication = ESPCommunication.getInstance()
    ...
    def handle_all_device_info(self):
        ...
        # if we use the jsonify here, the flask context couldnt be created, that return runtime
...
if __name__ == "__main__":
    ...
    print(flask_controller.handle_all_device_info())
    # flask_controller.handle_single_device_status("LED_01")
    # flask_controller.handle_all_device_info()
    # flask_controller.handle_all_device_info()
